/**********************************************************************************
 * $URL: https://source.etudes.org/svn/apps/configure/trunk/configure-webapp/webapp/src/java/org/etudes/configure/cdp/ConfigureServlet.java $
 * $Id: ConfigureServlet.java 5274 2013-06-27 15:44:38Z ggolden $
 ***********************************************************************************
 *
...
{
	/** Our log (commons). */
	private static Log M_log = LogFactory.getLog(ConfigureServlet.class);
	...
	public void init(ServletConfig config) throws ServletException
	{
		...
		final CdpHandler handler = new ConfigureCdpHandler();
